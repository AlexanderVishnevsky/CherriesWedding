...
const InitScripts = (): JSX.Element => (
    <Head>
        ...
        <meta name="theme-color" content={themes.lightTheme.palette.primary.main} />
        {/*Windows Phone*/}
        <meta name="msapplication-navbutton-color" content={themes.lightTheme.palette.primary.main} />
        {/*iOS Safari*/}
        <meta name="apple-mobile-web-app-status-bar-style" content={themes.lightTheme.palette.primary.main} />
        <meta content={`ya-title=${themes.lightTheme.palette.primary.main},ya-dock=fade`} />
        <meta name="msapplication-navbutton-color" content={themes.lightTheme.palette.primary.main} />
